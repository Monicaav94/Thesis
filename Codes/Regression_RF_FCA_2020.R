...
# Load raster layers
  slope <- raster("/dgm_5m/mosaic/slope_res20_horn.tif")
  aspect <- raster("/dgm_5m/mosaic/aspect_res20_horn.tif")
  soil <- raster("/acostave/soilinformation_1000_20mutm32.tif")
  entropy <- raster("/acostave/Entropy2/mosaic_entropy.tif")
  forestcover <- raster("/acostave/Forest_Count/forestcount.tif")
  fca <- raster("/2020/tif-Germany_cog/Forest_condition_v0007-0005_Germany_2020_full_bmean_R20m_cog.tif")
  elevation <- raster("/acostave/elevation_cleaned.tif")
  twi <- raster("/home/acostave/twi_res20_cog.tif")
  dominant_sp <- raster("/Species_Dominant/species_dominant_mosaic.tif")
